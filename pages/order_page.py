...
class OrderPage(BasePage):
    ...
    def set_field_date(self, date):
        self.send_keys_to_input(OrderPageLocators.DATE, date)
    ...
    def set_rental_period(self, period):
        ...
        period_locator = (OrderPageLocators.RENTAL_OPTION[0], OrderPageLocators.RENTAL_OPTION[1].format(period))
    ...
    def get_success_message(self):
        return self.get_element_text(OrderPageLocators.SUCCESS_TITLE)